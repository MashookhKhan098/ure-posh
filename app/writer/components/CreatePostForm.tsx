...
export default function CreatePostForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!writerUserStr) {
        alert('Writer session not found. Please login again.')
        return
      }
      
      const writerUser = JSON.parse(writerUserStr)
      
      // Add writer ID and author name to form data
      submitFormData.append('writer_id', writerUser.writer_id)
      submitFormData.append('author', writerUser.full_name || writerUser.username)
      ...
      if (response.ok) {
        ...
        alert('Article submitted successfully! It will be reviewed by admin before publishing.')
