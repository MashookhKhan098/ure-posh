...
export async function POST(req: NextRequest) {
  try {
    ...
    let writerQuery = supabase
      .from('writer')
      .select('id, username, full_name, password_hash, bio, phone, is_active, company_updates, compliance_legal_insights, news_media_coverage, newsletter_archive, thought_leadership, workplace_stories, events_webinars, international_regulatory_policy_watch, united_kingdom_workplace, us_workplace')
